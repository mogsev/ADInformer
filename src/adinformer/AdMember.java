...
public class AdMember {
    ...
    public String[] getAttributes() {
        ...
        for (listAttribute list : listAttribute.values()) {
            switch (list) {
                case sAMAccountName:
                    result[list.ordinal()] = sAMAccountName;
                    break;
                case name:
                    result[list.ordinal()] = name;
                    break;
                case mail:
                    result[list.ordinal()] = mail;
                    break;
                case title:
                    result[list.ordinal()] = title;
                    break;
                case department:
                    result[list.ordinal()] = department;
                    break;
                case telephoneNumber:
                    result[list.ordinal()] = telephoneNumber;
                    break;
                case ipPhone:
                    result[list.ordinal()] = ipPhone;
                    break;
                case mobile:
                    result[list.ordinal()] = mobile;
                    break;
                case company:
                    result[list.ordinal()] = company;
                    break;
            }
        }
        return result;
    ...
    public String toString() {
        ...
        for (listAttribute list : listAttribute.values()) {
            switch (list) {
                case sAMAccountName:
                    result.append(list).append(": ").append(sAMAccountName).append("\t");
                    break;
                case name:
                    result.append(list).append(": ").append(name).append("\t");
                    break;
                case mail:
