...
public class SortMember implements Comparator<AdMember>{
    ...
    public int compare(AdMember o1, AdMember o2) {
        switch(nameAttribute) {
            case title: return o1.getTitle().compareTo(o2.getTitle());                
            case department: return o1.getDepartment().compareTo(o2.getDepartment());
            case sAMAccountName: return o1.getsAMAccountName().compareTo(o2.getsAMAccountName());
        }
