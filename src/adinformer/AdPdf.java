...
public class AdPdf {  
    ...
    private PdfPTable getContentTable(AdMember member) throws DocumentException, IOException {
        ...
        if (!member.getTelephoneNumber().isEmpty()) {telephone.append("Tel: ").append(member.getTelephoneNumber()).append("\r\n");}
        if (!member.getIpPhone().isEmpty()) {telephone.append("VoIP: ").append(member.getIpPhone()).append("\r\n");}
        if (!member.getMobile().isEmpty()) {telephone.append("Mob: ").append(member.getMobile()).append("\r\n");}
